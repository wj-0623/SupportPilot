...
| 标杆能力 | V3 对应实现 |
| --- | --- |
| Intercom 的 preview、batch test、simulation 分层与无真实副作用沙箱 | Domain Pack Draft、`/admin/simulations/chat` 隔离模拟、40 项版本化回归、人工发布 |
...
| Chatwoot omnichannel inbox | Chatwoot handoff adapter；渠道 webhook 边界 |
| Agent Health 的 trajectory evaluation | AgentRun observations、OTel node spans、workflow checkpoint 和版本字段 |
